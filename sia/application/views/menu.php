				...
				<ul class="nav navbar-nav">
					...
					<?php if ($CI->getStatus() != 3) : ?>
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<?php if ($CI->cekLoginStatus("sswk")) : ?>
									<li><a href="<?php echo site_url('siswa') ?>">Santri</a></li>
								<?php endif; ?>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<?php if ($CI->cekLoginStatus("sswk")) : ?>
									<li><a href="<?php echo site_url('kelassiswa') ?>">Tempati (Kelas Santri)</a></li>
								<?php endif; ?>
								...
								<?php if ($CI->cekLoginStatus("sswkgr")) : ?>
									<li><a href="<?php echo site_url('nilaipelajaran') ?>">Nilai Pelajaran Santri</a></li>
								<?php endif; ?>

								<?php if ($CI->cekLoginStatus("sswk")) : ?>
									<li><a href="<?php echo site_url('nilaikepribadian') ?>">Nilai Kepribadian Santri</a></li>
								<?php endif; ?>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="<?php echo site_url('kelassiswa/rekap/guru') ?>">Laporan Santri Per Kelas</a></li>
								<li><a href="<?php echo site_url('nilaikepribadian/rekap/guru') ?>">Laporan Nilai Kepribadian Santri</a></li>
								<li><a href="<?php echo site_url('nilaipelajaran/rekap/guru') ?>">Laporan Nilai Pelajaran Santri</a></li>
								<li><a href="<?php echo site_url('nilaiekskul/rekap/guru') ?>">Laporan Nilai Ekstrakulikuler Santri</a></li>
								<li><a href="<?php echo site_url('absen/rekap/guru') ?>">Laporan Absensi Santri</a></li>
								...
								<li><a href="<?php echo site_url('raport') ?>">Raport Santri</a></li>
							</ul>
						</li>
					<?php else : ?>
