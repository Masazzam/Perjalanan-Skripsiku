			...
			<div class="panel panel-default form-master">
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group">
							<label for="nis" class="col-sm-2 control-label">Santri</label>
							<div class="col-sm-3">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" required="required" id="no_absen" placeholder="input no absen" name="no_absen" value="<?php echo $data->no_absen; ?>" />
							</div>
						</div>
					</div>
				</div>
