...
<div id="body-container">
	<div class="container">
		...
		<?php endif; ?>
		<form method="post" action="<?php echo site_url("nilaiekskul/save") ?>">
			<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $data->id_nilaiekskul; ?>">
			<div class="panel panel-default form-master">
					...
					<div class="row">
						<div class="col-md-4  pull-right">
							<div class="form-action pull-right">
								...
								<a href="<?php echo site_url("nilaiekskul") ?>" class="btn btn-danger">Cancel</a>
							</div>
						</div>
					</div>
				</div>
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group">
							<label for="id_kelas" class="col-sm-2 control-label">Ekskul</label>
							<div class="col-sm-2">
								<select class="form-control input-sm" name="id_ekskul">
									<?php foreach ($ekskul as $k) : ?>
										<option value="<?php echo $k['id_ekskul']; ?>" <?php echo $data->id_ekskul == $k['id_ekskul'] ? ' selected' : ''; ?>><?php echo $k['nm_ekskul'] ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" id="nilai" placeholder="input nilai" name="nilai" required="required" value="<?php echo $data->nilai; ?>">
							</div>
						</div>
					</div>
				</div>
