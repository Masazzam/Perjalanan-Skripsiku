...
<div id="body-container">
	<div class="container">
		...
		<?php endif; ?>
		<form method="post" action="<?php echo site_url("nilaikepribadian/save") ?>">
			<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $data->id_nilaikepribadian; ?>">
			<div class="panel panel-default form-master">
					...
					<div class="row">
						<div class="col-md-4  pull-right">
							<div class="form-action pull-right">
								...
								<a href="<?php echo site_url("nilaikepribadian") ?>" class="btn btn-danger">Cancel</a>
							</div>
						</div>
					</div>
				</div>
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group">
							<label for="id_kelas" class="col-sm-2 control-label">Kepribadian</label>
							<div class="col-sm-2">
								<select class="form-control input-sm" name="id_kepribadian">
									<?php foreach ($kepribadian as $k) : ?>
										<option value="<?php echo $k['id_kepribadian']; ?>" <?php echo $data->id_kepribadian == $k['id_kepribadian'] ? ' selected' : ''; ?>><?php echo $k['deskripsi'] ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							<label for="id_tempati" class="col-sm-2 control-label">Santri</label>
							<input type="hidden" class="form-control" id="id_tempati" name="id_tempati" value="<?php echo $data->id_tempati; ?>" />
							<div class="col-sm-3">
								<input type="text" class="form-control" id="nis" placeholder="pilih Santri" name="nis" value="<?php echo $data->nis; ?>" readonly />
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea class="form-control" rows="3" id="deskripsi" name="deskripsi" placeholder="input deskripsi"><?php echo $data->deskripsi; ?></textarea>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal-dialog ajax-modal" style="margin-top:100px;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Pilih Santri</h4>
			</div>
