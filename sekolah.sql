...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2020 at 02:48 PM
...
('X01', 'PRAMUKA'),
('X02', 'Santri Sahabat Bumi'),
('X03', 'Radio Gesma FM'),
('X04', 'Raudlatul Athfal');
...
('P01', 'Riyadlus Solikhin', 70),
('P02', 'Bulughul Maram', 65),
('P03', 'At Tibyan Fimalathil Qur''an', 90),
('P04', 'Aqidatul Awam Awaliyah', 100);
...
('U000000009', 'azzam', 'a8698009bce6d1b8c2128eddefc25aad', 1);
